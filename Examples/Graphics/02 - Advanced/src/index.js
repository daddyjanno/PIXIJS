...
bezier.stroke({ width: 5, color: 'red' })
...
realPath2.stroke({ width: 2, color: 'white' })
...
bezier2.stroke({ width: 5, texture: sprite.texture })
...
arc.arc(600, 100, 50, Math.PI, Math.PI * 2)
...
arc2.arc(650, 270, 50, 2 * Math.PI, (3 * Math.PI) / 2)

import { Application, Text, Color, FillGradient, TextStyle } from 'pixi.js'

console.log('Example - 01 - Pixi Text')
...
const richText = new Text({
    text: 'Rich text with a lot of options and across mutliple lines',
    style,
})
richText.x = 50
richText.y = 220
